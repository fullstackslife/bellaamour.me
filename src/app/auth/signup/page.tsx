...
import { Heart, Mail, Lock, User, Camera, Star } from "lucide-react"
    ...
    <div className="min-h-screen bg-gradient-to-br from-zinc-50 to-zinc-100 dark:from-zinc-950 dark:to-zinc-900 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="flex items-center justify-center space-x-2 mb-8">
          ...
          <span className="text-2xl font-bold text-zinc-900 dark:text-zinc-100">BellaAmour</span>
        </div>

        <Card className="border-zinc-200 dark:border-zinc-800">
          <CardHeader className="text-center">
            <CardTitle className="text-2xl">Join BellaAmour</CardTitle>
            <CardDescription>
              Create your account and start building your creator business
            </CardDescription>
          </CardHeader>
          <CardContent>
